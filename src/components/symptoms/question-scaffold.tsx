  ...
  return (
    <SafeAreaView edges={['top', 'bottom']} className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 px-6" contentContainerClassName="pt-3 pb-6">
        ...
        {description ? (
          <Text className="text-sm text-neutral-600 mb-4">{description}</Text>
        ) : (
          <View className="mb-4" />
        )}
        {children}
      ...
      <View className="flex-row gap-3 px-6 pt-3 pb-4 border-t border-neutral-100">
        <Pressable
          accessibilityRole="button"
          accessibilityLabel={t('symptoms.questionnaire.back')}
          onPress={onBack}
          className="min-h-[52px] flex-1 items-center justify-center rounded-xl border-2 border-neutral-200 active:bg-neutral-100">
